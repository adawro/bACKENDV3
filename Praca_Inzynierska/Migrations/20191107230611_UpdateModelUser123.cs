    ...
    public partial class UpdateModelUser123 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
               ...
               values: new object[] { "b01bex90-aa65-4af8-bd17-00bd9344e575", 0, "651ec58e-cc5a-45da-a5ec-cfede9c1911d", "test@test.test", true, "Konto", "Testowe", false, null, "TEST@TEST.TEST", "TEST@TEST.TEST", "AQAAAAEAACcQAAAAEJFqScrdk+4XcBaC+7TCBnWtLJVMxfSwkifYus1zn1q0Is8FIjolV19YVoKrzEHLiA==", null, false, "", false, "test", "TEST" });
        }
